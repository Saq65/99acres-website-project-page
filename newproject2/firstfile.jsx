...
export function FirstFile() {
    ...
    return (
        <div id="main" className="container-fluid-lg">
                    ...
                    <div className="col-lg-8 col-12">
                            ...
                            <div id="hide" style={{ height: '165px' }} className="col-lg-6">
                                <div style={{ cursor: 'pointer' }} className="card h-100 m-1">
                                    <iframe id="YouTubeVideo-ba1b5e9c-3109-42e0-bb95-2da230a450c8"
                                        ...
                                        autoplay allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                                        title="Bharatsthali Sarees & Dress Material @ Wedding Shopping Chandigarh"
                                        src="https://www.youtube.com/embed/Yx_2hReZJ6M?list=TLGGo1Ydw-LZrZ0wOTA0MjAyNA" tabindex="-1"></iframe>
                                    <div className="card-img-overlay d-flex align-items-end">
                                        <div className="card-body">
                                            <div className="card-text d-flex justify-content-between">
                        ...
                        <div className="mt-5">
                            ...
                            <div>
                                ...
                                <div style={{ width: '35%' }} className="card shadow border-0">
                        ...
                        <div id="slider" className="mt-3">
                            <div className="p-2" style={{ backgroundColor: '#F6FBFF' }}>
                                ...
                                <Slider {...Setting} className="hello">
                        ...
                        <div className="mt-4">
                            ...
                            <div className="mt-4">
                                <div className="row border h-100 align-items-center w-100">
                                    <div style={{ cursor: 'pointer', backgroundColor: '#F0F9FF' }} className="col-lg-2 col-2">
                                        <img src="https://static.99acres.com/universalapp/img/downloadpriceList.png" className="img-fluid" alt="" />
                                    </div>
                                    <div className="col-lg-7 col-6">
                                        <p className="fw-bold">Download Payment Plan & Price List of <br /> Vessella Woods</p>
                                    </div>
                                ...
                                <div className="slider-8">
                                    <Slider {...Setting8}>
                                        <Card className="m-2 ">
                                            ...
                                            <div style={{ height: '150px' }} className="d-flex mx-auto">
                                                <div className="img">
                                                    <img style={{ borderRadius: '50%', height: '80px' }} src="https://newprojects.99acres.com/projects/unknown/incor_lake_city/images/vxgiitu_1710246758_479409316_med.jpg" alt="" className="img-fluid" />
                                                </div>
                                                <div className="txt mx-3">
                                                    <h6>Incor Lake City</h6>
                                        ...
                                        <Card className="m-2">
                                            ...
                                            <div className="d-flex ">
                                                <div className="img">
                                                    <img style={{ borderRadius: '50%', height: '70px' }} src="https://newprojects.99acres.com/projects/trishala_constrcutions/trishala_trilok/images/zcxdmkl_1707220344_471837256_med.jpg" alt="" className="img-fluid" />
                                                </div>
                                                <div className="txt mx-3">
                                                    <h6>Trishala Trilok</h6>
                                        ...
                                        <Card className="m-2">
                                            ...
                                            <div className="d-flex ">
                                                <div className="img">
                                                    <img style={{ borderRadius: '50%', height: '80px' }} src="https://newprojects.99acres.com/projects/gamut_india_projects/gamut_saraa_city/images/cinzb2j_1711435947_482253632_med.jpg" alt="" className="img-fluid" />
                                                </div>
                                                <div className="txt mx-3">
            ...
            <div className="container-fluid-lg d-block expolore1 mt-5">
            ...
            <div id="instruction" className="conainer-fluid-lg w-75 mt-3">
                <div className="row w-100">
            ...
            <div id="locality" className="container-fluid-lg mt-5">
                ...
                <div className="mt-5">
                    <div id="review" style={{ height: '450px' }} className="review-box border rounded border m-2">
                        <div className="row w-100 h-100 mx-auto align-items-center">
            ...
            <div id="poster" className="mt-5 m-2">
                <div style={{ backgroundColor: '#FFFBF3' }} className="rounded p-3">
                    <p style={{ fontSize: '8pt', float: 'right' }}>Last Modified on 21 Oct, 2022</p>
                    <div className="d-flex">
                        <div className="">
                            <h3>
                        ...
                        <div style={{ height: '130px', width: '30vh' }} className="card mx-2 shadow-md p-2 img">
                            ...
                            <div className="card-body">
                                <p style={{ fontSize: '9pt' }} className="text-secondary">Tata Capital Housing Finance Limited <br />
                                    <span className="text-bold text-dark text-center fs-6">8.90% Interest</span> </p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div id="projects" className="mt-5">
                ...
                <div className="img mt-3">
                    <div style={{ width: '320px', height: '200px' }} className="card m-2 rounded">
            ...
            <div className="article mt-5">
                ...
                <div id="articleSlider" className="slider">
                    <Slider {...article}>
                        <div className="card-wrapper">
                            <div style={{ height: '320px' }} className="card">
                                <img className="img-fluid" src="https://www.99acres.com/microsite/wp-content/blogs.dir/6161/files/2024/04/Krishe-Pearl-270x180.jpg?1712926634000" alt="" />
                                <div className="card-body">
                        ...
                        <div className="card-wrapper">
                            <div style={{ height: '320px' }} className="card">
                                <img style={{ height: '210px' }} className="img-fluid" src="https://www.99acres.com/microsite/wp-content/blogs.dir/6161/files/2023/11/building-240x180.jpeg?1712750931000" alt="" />
                                <div className="card-body">
                        ...
                        <div className="card-wrapper">
                            <div style={{ height: '320px' }} className="card">
                                <img style={{ height: '210px' }} className="img-fluid" src="https://www.99acres.com/microsite/wp-content/blogs.dir/6161/files/2024/04/sreenidhi-serengeti-defualt-image-350x169.jpeg?1712747388000" alt="" />
                                <div className="card-body">
                        ...
                        <div className="card-wrapper">
                            <div style={{ height: '320px' }} className="card">
                                <img style={{ height: '210px' }} className="img-fluid" src="https://www.99acres.com/microsite/wp-content/blogs.dir/6161/files/2024/04/Aparna-Newlands-329x180.jpg?1712645629000" alt="" />
                                <div className="card-body">
                        ...
                        <div className="card-wrapper">
                            <div style={{ height: '320px' }} className="card">
                                <img style={{ height: '210px' }} className="img-fluid" src="https://www.99acres.com/microsite/wp-content/blogs.dir/6161/files/2024/04/Svadha-mackenna-feature-image-240x180.jpg?1712247244000" alt="" />
                                <div className="card-body">
                        ...
                        <div className="card-wrapper">
                            <div style={{ height: '320px' }} className="card">
                                <img style={{ height: '210px' }} className="img-fluid" src="https://www.99acres.com/microsite/wp-content/blogs.dir/6161/files/2024/03/sampada-central-residency-350x178.jpg?1712232508000" alt="" />
                                <div className="card-body">
                        ...
                        <div className="card-wrapper">
                            <div style={{ height: '320px' }} className="card">
                                <img style={{ height: '210px' }} className="img-fluid" src="https://www.99acres.com/microsite/wp-content/blogs.dir/6161/files/2024/03/Makuta-2-1-240x180.jpg?1711709467000" alt="" />
                                <div className="card-body">
                        ...
                        <div className="card-wrapper">
                            <div style={{ height: '320px' }} className="card">
                                <img style={{ height: '210px' }} className="img-fluid" src="https://www.99acres.com/microsite/wp-content/blogs.dir/6161/files/2024/03/Ramky-One-Orion-1-350x147.jpg?1711603117000" alt="" />
                                <div className="card-body">
            ...
            <div id="Arrow" className="rounded-5 arrow" style={{ left: '96%', position: 'fixed', top: '620px' }}>
